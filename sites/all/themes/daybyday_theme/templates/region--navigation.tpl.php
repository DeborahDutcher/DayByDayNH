    ...
    <nav id="navigation" role="navigation" class="yamm">
        <div class="navbar navbar-default">
                ...
                <div class="navbar-header">
                    ...
                    <a href="/" class="navbar-brand"><img src="/sites/all/themes/daybyday_theme/images/logo_sm.png" alt="<?php print $site_name; ?>" /></a>
                </div>
                <div class="navbar-collapse collapse">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            <a href="/places-to-see" class="dropdown-toggle">Seek and Explore</a>
                        </li>
                        <li class="dropdown">
