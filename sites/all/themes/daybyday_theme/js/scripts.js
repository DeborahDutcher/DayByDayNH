(function ($) {
    ...
    if(stringInArray(monthURL, months)) {
        $(".sub-nav-wrap").backstretch("/sites/all/themes/daybyday_theme/images/months/bg-" + monthURL + ".jpg");
        $(".header").backstretch("/sites/all/themes/daybyday_theme/images/months/head-bg-" + monthURL + ".png");
    } else {
        $(".sub-nav-wrap").backstretch("/sites/all/themes/daybyday_theme/images/months/bg-cover" + bgImg +".jpg");
    }
